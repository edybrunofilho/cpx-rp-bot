...
export function contextualAnswer(question,view){
 ...
 if(/cargo|permiss|prefeit|governo|admin/.test(q))return 'O acesso real vem dos cargos configurados no Discord. Prefeito e vice usam a Prefeitura; Governo usa o tesouro estadual; Administrador gerencia saldos e moderação. Não altero cargos. Peça à administração para verificar sua permissão.';
